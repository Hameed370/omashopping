...
<meta name="author" content="Hameed Ansari">
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${contextRoot}/home"><img
					src="${img}/logo.jpg" alt="oma" height="50" width="50"
					class="img-circle"></a>
			</div>
		...
		<div class="row">
			...
			<div class="form-container col-md-6">
				<form:form class="form-horizontal" method="POST"
					...
					<div class="row">
						<div class="form-group">
							<label class="col-md-3 control-lable" for="contactNumber">CONTACT</label>
			...
			<%-- 		<div class="row">
						<div class="form-group">
							<label class="col-md-3 control-lable" for="billAddress">ADDRESS</label>
							<form:input path="billAddress" type="text" class="form-control"
								placeholder="Enter Address" />
							<div class="has-error">
								<form:errors style="color:red" path="billAddress"
									class="help-inline" />
							</div>
						</div>
					</div>
